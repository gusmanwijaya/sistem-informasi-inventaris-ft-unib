<div class="modal fade" id="tambahBarangLaboratorium" tabindex="-1" aria-labelledby="tambahBarangLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="/data-barang-laboratorium-admin/tambahLaboratorium">
          {{ csrf_field() }}
          ...
          <div class="form-group {{ $errors->has('laboratorium_id') ? 'has-error' : '' }}">
                ...
                >
                  ...
                  <option value="{{ $laboratorium->id }}" 
                    {{ (old('laboratorium_id') == $laboratorium->id) ? 'selected' : '' }}>
