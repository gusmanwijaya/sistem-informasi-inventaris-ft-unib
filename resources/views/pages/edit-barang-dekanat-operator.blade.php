...
<div class="container-fluid" id="toastvue">
    <a href="/data-barang-dekanat-operator"><i class="fas fa-fw fa-arrow-left mb-3"></i></a>
    <h4 class="mb-3">Edit Barang Dekanat</h4>
    <div class="row">
        <div class="col-12">
        <form method="POST" action="/data-barang-dekanat-operator/updateDekanat-{{ $data_barang_dekanat->id }}">
            {{ csrf_field() }}
            <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <div class="form-group {{ $errors->has('kode_barang') ? 'has-error' : '' }}">
                        ...
                        <select
                            ...
                            >
                                ...
                                <option value="{{ $kode->kode_barang }}" @if($data_barang_dekanat->kode_barang == $kode->kode_barang) selected @endif>
                                    {{ $kode->kode_barang }}
                                </option>
                                @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('nama_barang') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="nama_barang" name="nama_barang" class="form-control" value="{{ $data_barang_dekanat->nama_barang }}" disabled>
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('merek') ? 'has-error' : '' }}">
                        ...
                        name="merek" value="{{ $data_barang_dekanat->merek }}" disabled>
                        @if($errors->has('merek'))
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('jumlah') ? 'has-error' : '' }}">
                        ...
                        <select
                            ...
                            >
                            @for ($i = 1; $i <= 500; $i++)
                            <option value="{{ $i }}" @if($data_barang_dekanat->jumlah == $i) selected @endif>{{ $i }}</option>
                            @endfor
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('satuan') ? 'has-error' : '' }}">
                        ...
                        disabled
                        >
                        <option value="Set" @if($data_barang_dekanat->satuan == "Set") selected @endif>Set</option>
                        <option value="Buah" @if($data_barang_dekanat->satuan == "Buah") selected @endif>Buah</option>
                        <option value="Lembar" @if($data_barang_dekanat->satuan == "Lembar") selected @endif>Lembar</option>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('asal_barang') ? 'has-error' : '' }}">
                        ...
                        <select name="asal_barang" id="asal_barang" class="form-control" disabled>
                            ...
                            <option value="APBN" @if($data_barang_dekanat->asal_barang == "APBN") selected @endif>APBN</option>
                            <option value="PNBP" @if($data_barang_dekanat->asal_barang == "PNBP") selected @endif>PNBP</option>
                            <option value="HIBAH" @if($data_barang_dekanat->asal_barang == "HIBAH") selected @endif>HIBAH</option>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('tahun_barang') ? 'has-error' : '' }}">
                        ...
                        <select name="tahun_barang" class="form-control" disabled>
                            ...
                            @for ($i = 2000; $i <= 2100; $i++)
                            <option value="{{ $i }}" @if($data_barang_dekanat->tahun_barang == $i) selected @endif>
                                {{ $i }}</option>
                            @endfor
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('ruangan_id') ? 'has-error' : '' }}">
                        ...
                        <option value="{{ $dekanat->id }}" @if($data_barang_dekanat->ruangan_id == $dekanat->id) selected @endif>
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('kondisi') ? 'has-error' : '' }}">
                        ...
                        class="form-control"
                        >
                        <option value="Baik" @if($data_barang_dekanat->kondisi == "Baik") selected @endif>Baik</option>
                        <option value="Rusak" @if($data_barang_dekanat->kondisi == "Rusak") selected @endif>Rusak</option>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('ada_tidak') ? 'has-error' : '' }}">
                        ...
                        class="form-control"
                        >
                        <option value="Ada" @if($data_barang_dekanat->ada_tidak == "Ada") selected @endif>Ada</option>
                        <option value="Tidak" @if($data_barang_dekanat->ada_tidak == "Tidak") selected @endif>Tidak</option>
                        </select>
        ...
        $(document).ready(function(){
            $('.dynamic').change(function(){
                if($(this).val() != '') {
                    ...
                    $.ajax({
                        url: "{{ route('data-barang-dekanat-operator-fetch') }}",
                        method: "POST",
                        data: {
