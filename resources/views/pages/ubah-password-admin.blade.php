...
@section('title')
    Ubah Password Admin - SI Inventaris Barang FT UNIB
@endsection

@section('content')
<div class="container-fluid" id="toastvue">
    <a href="/profile-admin"><i class="fas fa-fw fa-arrow-left mb-3"></i></a>
    <h4 class="mb-3">Ubah Password Admin</h4>
    <div class="row">
        <div class="col-12">
        <form method="POST" action="/ubah-password-admin/edit-{{ auth()->user()->id }}">
            {{ csrf_field() }}
            <div class="card">
            <div class="card-body">
                <div class="row mb-2">
