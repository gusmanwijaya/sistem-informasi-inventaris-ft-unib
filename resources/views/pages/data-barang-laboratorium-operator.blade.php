    ...
    <div class="card shadow mb-4" data-aos="fade-left">
        <div class="card-header">
            <div class="row justify-content-start align-items-center ml-0">
                <a href="/data-barang-laboratorium-operator/exportLaboratorium" data-aos="fade-left" class="btn btn-sm btn-import">
                    <i class="fas fa-file-excel p-1"></i> Export .xlsx</a>
            </div>
        </div>
        <div class="card-body">
            <form action="/data-barang-laboratorium-operator" method="GET">
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-3 mt-2">
                        ...
                        <a href="/data-barang-laboratorium-operator" class="btn btn-sm btn-outline-secondary"><i class="fas fa-sync p-1"></i> Refresh</a>
                    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row justify-content-center">
                                <a href="/data-barang-laboratorium-operator/editLaboratorium-{{ $laboratorium->id }}" class="mr-2"
