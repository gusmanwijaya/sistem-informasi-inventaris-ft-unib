...
<div class="container-fluid" id="toastvue">
    <a href="/data-barang-laboratorium-admin"><i class="fas fa-fw fa-arrow-left mb-3"></i></a>
    <h4 class="mb-3">Edit Barang Laboratorium</h4>
    <div class="row">
        <div class="col-12">
        <form method="POST" action="/data-barang-laboratorium-admin/updateLaboratorium-{{ $data_barang_laboratorium->id }}">
            {{ csrf_field() }}
            <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('nama_barang') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="nama_barang" class="form-control" name="nama_barang" value="{{ $data_barang_laboratorium->nama_barang }}">
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('merek') ? 'has-error' : '' }}">
                        ...
                        name="merek" value="{{ $data_barang_laboratorium->merek }}" >
                        @if($errors->has('merek'))
