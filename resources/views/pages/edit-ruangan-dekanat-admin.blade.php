...
<div class="container-fluid" id="toastvue">
    <a href="/data-ruangan-dekanat-admin"><i class="fas fa-fw fa-arrow-left mb-3"></i></a>
    <h4 class="mb-3">Edit Ruangan Dekanat</h4>
    <div class="row">
        <div class="col-12">
        <form method="POST" action="/data-ruangan-dekanat-admin/updateDekanat-{{ $data_dekanat->id }}">
            {{ csrf_field() }}
            <div class="card">
            <div class="card-body">
                <div class="row mb-2">
